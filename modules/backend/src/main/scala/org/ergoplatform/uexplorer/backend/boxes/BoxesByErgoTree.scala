...
trait BoxesByErgoTree extends Codecs:
  ...
  protected[backend] val spentContractBoxesByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[Box], Any] =
    endpoint.get
  ...
  protected[backend] val spentContractBoxIdsByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[BoxId], Any] =
    endpoint.get
  ...
  protected[backend] val unspentContractBoxesByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[Utxo], Any] =
    endpoint.get
  ...
  protected[backend] val unspentContractBoxIdsByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[BoxId], Any] =
    endpoint.get
  ...
  protected[backend] val anyContractBoxesByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[Box], Any] =
    endpoint.get
  ...
  protected[backend] val anyContractBoxIdsByErgoTree: PublicEndpoint[(String, QueryParams), String, Iterable[BoxId], Any] =
    endpoint.get
